#include "VCorps.h"
#include "VCorps_Corps.h"
#ifdef REF
#include "VCorps_RiscvCore.h"
#endif
#include "verilated.h"
...
public:
	...
	VexRiscvTracer(VCorps_VexRiscv *cpu){
		this->cpu = cpu;
...
class CorpsWorkspace : public Workspace<VCorps>{
public:
	CorpsWorkspace() : Workspace("Corps"){
		...
		//axiClk->add(new VexRiscvTracer(top->Corps->axi_core_cpu));
